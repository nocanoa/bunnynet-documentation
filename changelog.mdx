...
Maximize screen real estate on the bunny player with Compact Controls. Ideal for mobile and embedded players. You can now enable compact controls on your video library via the 'update video library' API endpoint or by adding 'compactControls=true' to your player embed parameters. 
[Learn more](/api-reference/core/stream-video-library/update-video-library#response-enable-compact-controls)
