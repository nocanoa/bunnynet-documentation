...
```bash
npm create astro@latest bunny-astro-app
cd bunny-astro-app
```
...
<Tabs>
  <Tab title="GitHub Actions">
    ...
    git remote add origin https://github.com/YOUR_USERNAME/bunny-astro-app.git
  ...
  <Tab title="Docker CLI">
    ...
    <DockerCliSteps imageName="bunny-astro-app" />
...
<DeploySteps imageName="bunny-astro-app" />
