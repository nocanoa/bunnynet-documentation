...
```bash
npx create-next-app@latest bunny-nextjs-app
cd bunny-nextjs-app
```
...
<Tabs>
  <Tab title="GitHub Actions">
    ...
    git remote add origin https://github.com/YOUR_USERNAME/bunny-nextjs-app.git
  ...
  <Tab title="Docker CLI">
    ...
    <DockerCliSteps imageName="bunny-nextjs-app" />
...
<DeploySteps imageName="bunny-nextjs-app" />
