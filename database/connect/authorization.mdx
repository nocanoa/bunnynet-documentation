...
Navigate to **Dashboard > Edge Platform > Database > Access** to view and manage your database connection details.
...
1. Navigate to **Dashboard > Edge Platform > Database > Access**
