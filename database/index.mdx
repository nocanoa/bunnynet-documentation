...
description: "Bunny Database is a fully managed relational database service that lets you deploy simple, globally distributed SQL databases."
---
...
Bunny Database integrates with other bunny.net compute services:
