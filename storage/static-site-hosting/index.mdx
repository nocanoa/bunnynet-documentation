...
<Accordion title="Why SPAs need special configuration">
  ...
  client-side router to handle the URL.
</Accordion>
...
<Steps>
  ...
  <Step title="Set the action">
    Set the action to **Override Origin URL** with the value: ``` /index.html
    ```
  </Step>
  <Step title="Save the rule">Click **Save** to activate the rule.</Step>
</Steps>
