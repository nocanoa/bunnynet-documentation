---
title: "URL Fetch"
description: "Upload videos to Bunny Stream by providing a remote URL."
---
...
1. Finally click **'Upload Video'** to start the process of uploading directly from a URL.
...
6. Edit the Dropbox video file **Link** by updating **'dl=0'** to **'dl=1'** within your video link URL extension. Example:
   1. https://www.dropbox.com/scl/fi/k0nr5njo8hxjv31ez7hx9/example.mp4?rlkey=28mheq7emsr4tgptrc1t9e6lr&st=g611dzo4&dl=0
   2. https://www.dropbox.com/scl/fi/k0nr5njo8hxjv31ez7hx9/example.mp4?rlkey=28mheq7emsr4tgptrc1t9e6lr&st=g611dzo4&dl=1
1. Select **Upload Video**
2. **Your video will start uploading.**
