---
title: "Statistics"
description: Understand video analytics including views, watch time, engagement scores, and heatmaps.
---
...
### [All stream statistics are available over the Stream API](/api-reference/stream)
